...
print("echo '########################################################'")  
print("python3 eval_log_reg_CDR12.py '%s' '%s' '%s/Binary_group' %s 50 %s 1 | tee CDR1_log_Reg_group.txt"% (filepath, filename, filepath, length, rest))        
print("echo 'CDR1_Exact'")
print("echo '########################################################'")  
print("python3 eval_log_reg_CDR12.py '%s' '%s' '%s/Binary_exact' %s 50 %s 1 | tee CDR1_log_Reg_exact.txt"% (filepath, filename, filepath, length, rest))        
print("echo 'CDR2_group'")
print("echo '########################################################'")  
print("python3 eval_log_reg_CDR12.py '%s' '%s' '%s/Binary_group' %s 50 %s 2 | tee CDR2_log_Reg_group.txt"% (filepath, filename, filepath, length, rest))        
print("echo 'CDR2_exact'")
print("echo '########################################################'")  
print("python3 eval_log_reg_CDR12.py '%s' '%s' '%s/Binary_exact' %s 50 %s 2 | tee CDR2_log_Reg_exact.txt"% (filepath, filename, filepath, length, rest))        
print("echo 'CDR3_group'")
print("echo '########################################################'")  
print("python3 eval_log_reg_CDR3.py '%s' '%s' '%s/Binary_group' %s 50 %s | tee CDR3_log_Reg_group.txt"% (filepath, filename, filepath, length, rest))        
print("echo 'CDR3_exact'")
print("echo '########################################################'")  
print("python3 eval_log_reg_CDR3.py '%s' '%s' '%s/Binary_exact' %s 50 %s | tee CDR3_log_Reg_exact.txt"% (filepath, filename, filepath, length, rest))        

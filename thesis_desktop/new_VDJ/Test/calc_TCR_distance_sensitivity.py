...
from calc_CDR3_distance import dist_CDR3_pairwise_ham, CDR3_diagonal_dict, dist_CDR3_alignment, kmers_dist, Atchley_euclidean_dist, make_AA_to_Atchley_dict, Immunomap_Dist, physiocehmical_prop, vol_distance, CDRdist
...
def dist_i_list_parallel(TCR_i, CDR3_list, V_list, path):
    ...
    distance = np.array([CDRdist(TCR_i[0], cdr3, Blosum50_, 10, 0.5) for cdr3 in CDR3_list])

...
def TCRdist(Vgene_1, CDR3_1): 
    ...
    TCRdist_dict = defaultdict()
    TCRdist_dict[CDR1_alpha] = *1.0
    TCRdist_dict[CDR1_beta] = *1.0
    
    TCRdist_dict[CDR2_alpha] =  *1.0
    TCRdist_dict[CDR2_beta] =  *1.0
    
    TCRdist_dict[CDR25_alpha] =  *1.0
    TCRdist_dict[CDR25_beta] =  *1.0
    
    TCRdist_dict[CDR3_alpha] =  *3.0
    TCRdist_dict[CDR3_beta] =  *3.0

    return sum(TCRdist_dict.values())
